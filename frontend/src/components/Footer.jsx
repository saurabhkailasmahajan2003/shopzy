    ...
    <footer className="bg-gradient-to-b from-[#2a1a0f] to-[#1a0f08] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <div className="mb-6 bg-transparent">
              <img 
                ...
                alt="Shopzy Logo"
                className="h-14 w-auto object-contain mb-6 filter brightness-110"
                style={{ backgroundColor: 'transparent', background: 'transparent' }}
              />
            </div>
            <h3 className="text-white text-xl font-bold mb-4 tracking-wide">About Shopzy</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white text-xl font-bold mb-6 tracking-wide relative pb-2">
              Quick Links
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start group">
                <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center mr-3 group-hover:bg-amber-500/20 transition-all duration-300">
